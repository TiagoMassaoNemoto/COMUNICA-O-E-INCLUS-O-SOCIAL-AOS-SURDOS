...
data_folder = "C:\\Users\\Caioe\\OneDrive\\Documentos\\imagens alfabeto"  
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(26, activation='softmax')  # 26 unidades de saída para as letras do alfabeto
])
...
model.save('modelo_letra_alfabeto')