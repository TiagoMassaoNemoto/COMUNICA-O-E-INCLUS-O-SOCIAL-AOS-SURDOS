...
def main():
    ...
    #               👇👇👇👇 ex: 'letra A'
    output_folder = "C:\\Users\\timas\\Desktop\\Pratica\\Tirar foto\\C"  # Substitua pelo caminho desejado
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            ...
            try:
                img_cut = result3[y_min-50:y_max+50,x_min-50:x_max+50]
                img_cut = cv2.resize(img_cut,(224,224))
            ...
            if count % fps == 0:
                ...
                frame_name = os.path.join(output_folder, 'frame-C-%d.jpg' % (count // fps))
                cv2.imwrite(frame_name, img_cut)

            count += 1

            # Mostrar o frame capturado em uma janela
            cv2.imshow('Camera', img_cut)
